import userstory_parse.ReadXML;
...
public class DependencyDAO {
    ...
    public static void insertProject(String projectName, List<String> dependencies) {
        ...
        try{
            ...
            //get connection;
            if(!checkRepository(projectName, conn)){
                ...
                for (String dependency: dependencies) insertDependency(dependency, conn, repoID);
    ...
    public static Boolean checkRepository(String repoName, Connection conn) throws SQLException {

        boolean isRepo = false;
        try {

            PreparedStatement stmt = conn.prepareStatement("select * from repository where Name= ?");
