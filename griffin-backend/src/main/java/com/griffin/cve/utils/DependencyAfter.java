...
@Component
public class DependencyAfter {
    private final Environment environment;
    public DependencyAfter(Environment environment){
    ...
    public List<String> queryAfter(String name) {
        ...
        try {
            ...
            String queryBefore = "select dependency from repository where name = ? order by timestamp DESC limit 1";
